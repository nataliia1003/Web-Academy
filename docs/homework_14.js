...
var light = document.querySelector('.garland__light-bulb');
var button = document.querySelector('.garland__btn');
var intervalId;
...
function toggle() {
  var isEnabled = button.classList.contains('garland__btn-active');
